...
import { UserCreatedConsumer } from '../message-broker/kafka';
import { UpdateTrailConsumer } from '../message-broker/kafka/consumer/trail-update-consumer';
import { SubscriptionConsumer } from '../message-broker/kafka/consumer/subscription-consumer';
