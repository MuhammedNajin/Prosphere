...
import { UserCreatedConsumer } from "./infrastructure/message-broker/kafka";
...
class UserAppBuilder {
  ...
  private async setupRoutes(): Promise<void> {
    ...
    try {
      ...
      const { default: compayRouter } = await import("@presentation/routes");
      ...
      console.log("User router imported successfully, type:", typeof compayRouter);
      this.app.use("/api/v1", compayRouter);
