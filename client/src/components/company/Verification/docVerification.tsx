...
interface DocumentVerificationFormData {
...
const DocumentVerification: React.FC = () => {
  ...
  const form = useForm<DocumentVerificationFormData>({
    defaultValues: {
      companyDocType: "",
      ownerDocType: "",
      companyDoc: null,
  ...
  const companyVerificationMutation = useMutation({
    mutationFn: (params: { data: DocumentVerificationFormData; id: string }) =>
      CompanyApi.uploadVerificationDocs(params),
    onSuccess: (data) => {
  ...
  const onSubmit = async (data: DocumentVerificationFormData) => {
    try {
  ...
  const renderFileUploadSection = (
    title: string,
    docTypeField: keyof Pick<DocumentVerificationFormData, "companyDocType" | "ownerDocType">,
    fileField: keyof Pick<DocumentVerificationFormData, "companyDoc" | "ownerDoc">,
  ...
  return (
    <div className="max-w-3xl p-6 mx-auto">
      {companyVerificationMutation.isSuccess ||
          ...
          <Alert className="bg-blue-50 border-blue-200">
            ...
            <AlertDescription className="text-blue-700">
              <div className="space-y-2">
                <p>
                  Your documents have been successfully uploaded and are pending
                  review.
                </p>
          ...
          >
            ...
            <AlertTitle
              className={`flex items-center gap-2 ${
                company.status === "rejected" ? "text-red-900" : ""
              }`}
            >
