  ...
  return (
    <section className="flex overflow-hidden flex-col pb-6 bg-white border border-solid border-zinc-200 min-w-[240px] w-[446px] max-md:max-w-full">
      <header className="flex z-10 flex-col pt-7 pb-4 w-full text-xl font-semibold leading-tight text-gray-800 bg-white border border-solid shadow-2xl border-zinc-200 max-md:max-w-full">
        <h2 className="self-start ml-6 text-center max-md:ml-2.5">Upcoming Interviews</h2>
        ...
        <div className="flex gap-10 justify-between items-center mx-6 mt-4 max-md:mx-2.5">
          ...
          <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/0bc93cdc8984d42fda30292a3f5905803df08c309ac9fc5fad864f30fd9716db?placeholderIfAbsent=true&apiKey=942cdf39840f4ab69951fbe195dac732" className="object-contain shrink-0 self-stretch my-auto w-16 aspect-[2.67]" alt="" />
        </div>
      </header>
      <div className="flex flex-col px-6 pb-11 mt-0 w-full text-base leading-relaxed max-md:pl-5 max-md:max-w-full">
        <div className="flex flex-col w-full font-medium text-slate-500">
          <div className="flex flex-col items-start max-w-full text-gray-800 rounded-none w-[406px] max-md:pr-5">
            <span className="opacity-50">9:30 AM</span>
          </div>
          ...
          <div className="mt-11 max-w-full rounded-none w-[408px] max-md:pr-5 max-md:mt-10">
            10:30 AM
          </div>
          <div className="flex gap-4 mt-11 max-w-full rounded-none w-[406px] max-md:mt-10">
            <span>11:00 AM</span>
        ...
        <div className="flex z-10 gap-4 self-end py-4 pr-11 pl-4 mt-0 bg-violet-100 rounded-lg max-md:pr-5">
          <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/d01bd5d49e78d9455183687658be3629fdd5a65b77cff2906c3544cfa3770314?placeholderIfAbsent=true&apiKey=942cdf39840f4ab69951fbe195dac732" className="object-contain shrink-0 w-12 aspect-square" alt="Joe Bartmann profile" />
          <div className="flex flex-col self-start">
            <h3 className="self-start font-semibold text-slate-800">Joe Bartmann</h3>
            <p className="mt-1.5 font-medium text-slate-500">HR Manager at Divvy</p>
          </div>
        </div>
      </div>
    </section>
